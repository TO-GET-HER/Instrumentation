...
#
# Generated by export_simulation on Tue Jul 28 11:40:24 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Driver_DAC_0.sh' script.

./Driver_DAC_0.sh -reset_run
...
./Driver_DAC_0.sh -noclean_files

For more information on the script, please type './Driver_DAC_0.sh -help'.
