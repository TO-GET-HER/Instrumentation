...
#
# Generated by export_simulation on Wed Jul 29 14:39:10 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './Driver_ADC_0.sh' script.

./Driver_ADC_0.sh -reset_run
...
./Driver_ADC_0.sh -noclean_files

For more information on the script, please type './Driver_ADC_0.sh -help'.
