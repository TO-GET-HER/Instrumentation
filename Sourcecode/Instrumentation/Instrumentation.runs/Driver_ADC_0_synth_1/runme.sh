...
HD_PWD='E:/fpga/Instrumentation/Instrumentation.runs/Driver_ADC_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_ADC_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driver_ADC_0.tcl
