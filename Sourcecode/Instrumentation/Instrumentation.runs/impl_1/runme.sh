...
HD_PWD='E:/fpga/Instrumentation/Instrumentation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Instrumentation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Instrumentation.tcl -notrace
