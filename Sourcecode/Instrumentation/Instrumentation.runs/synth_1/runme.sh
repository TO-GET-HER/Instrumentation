...
HD_PWD='E:/fpga/Instrumentation/Instrumentation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Instrumentation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Instrumentation.tcl
